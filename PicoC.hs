...
eval (LT e1 e2) c = if (eval e1 c /= 0) < (eval e2 c /= 0) then 1 else 0
eval (GT e1 e2) c = if (eval e1 c /= 0) > (eval e2 c /= 0) then 1 else 0
eval (EQ e1 e2) c = if (eval e1 c /= 0) == (eval e2 c /= 0) then 1 else 0
